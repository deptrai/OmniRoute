...
```
capabilities/
├── breaker-state-probe.md          # When to run, what to do with results
└── breaker-state-probe.py          # The actual computation
```
...
capabilities/
└── incident-replay/
    ├── incident-replay.md     # Main guidance
