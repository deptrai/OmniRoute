...
import { PostmanAgentExecutor } from "./postman-agent.ts";
...
const executors = {
  ...
  "postman-agent": new PostmanAgentExecutor(),
  postman: new PostmanAgentExecutor(), // Alias
};
...
export { PostmanAgentExecutor } from "./postman-agent.ts";
